...
from .constants import CLI_NAME, PROJECT_NAME, TAGLINE, CLI_HELP, BANNER
...
SKILL_DESCRIPTIONS = {
    ...
    "codebasegraph": "Build a Python codebase dependency graph with imports, symbols, and reverse dependencies.",
